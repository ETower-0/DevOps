...
<body>
<table class="prod">
<form name="f1" id="f1" method="post" action="grabarInventarios.php" OnSubmit="return validacion(this);">
 
 <td><h1>Captura  Inventario</h1> <br></td>
 <tr>
 <td>Codigo Producto:</td> <td><input type="text" name="CodigoInventario" id="CodigoInventario"></td>
 <br>
 </tr>
 <tr>
 <td>Nombre Producto: </td> <td><input type="text" name="NombreProducto" id="NombreProducto"></td>
 <br>
 </tr>
 <tr>
 <td>Valor Producto: </td> <td><input type="number" name="ValorProducto" id="ValorProducto"></td>
 </tr>
<tr>
<td><button type="submit" value="Grabar vendedor">Grabar Producto
</button>
</table>
</form>
