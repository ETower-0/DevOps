...
<link rel="stylesheet" type="text/css" href="main4.css"> 
 ...
 <body>
 	<h1 class="logo">Eliminar<span> <br>Cliente</span></h1>	
<form method="POST" action="eliminarClientes.php">
<table class="mod">
 	
 		<td><input type="text" name="CodigoCliente"></td>
		<td><input type="submit" value="Eliminar Cliente por Codigo"></td>
...
<?php
    ...
    $consulta1 = "SELECT * FROM Facturas where CodigoCliente=".$_POST["CodigoCliente"];
...
ELSE 
    { 
    $consulta2 = "DELETE FROM Clientes where CodigoCliente=".$_POST["CodigoCliente"];
   // echo $consulta1;
