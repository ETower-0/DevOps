...
<link rel="stylesheet" type="text/css" href="main4.css"> 
 ...
 <body>
 	<h1 class="logo">Eliminar<span> <br>Vendedor</span></h1>	
<form method="POST" action="eliminarVendedores.php">
<table class="mod">
 	
 		<td><input type="text" name="Codigo"></td>
		<td><input type="submit" value="Eliminar Vendedor por Codigo"></td>
...
<?php
    ...
    $consulta1 = "SELECT * FROM Facturas where CodigoVendedor=".$_POST["Codigo"];
    $resultado = mysqli_query($conexion, $consulta1);
    $row_cnt = mysqli_num_rows($resultado);
    if($row_cnt >= 1){
			echo "<script type='text/javascript'>
    alert('No se puede Eliminar el Registro');
    window.location.href='eliminarVendedores.php';
    </script>";
      }
ELSE 
    { 
    $consulta2 = "DELETE FROM Vendedores where Codigo=".$_POST["Codigo"];
   // echo $consulta1;
